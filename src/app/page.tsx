...
import { ArrowDown, Code, PenTool, Database, Briefcase, Award } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-5 gap-16 items-start">
              ...
              <div>
                  ...
                  {timelineEvents.map((event, index) => (
                      <div key={index} className="relative pl-8 sm:pl-12 py-8 group">
                          <div className="flex items-center mb-1">
                              <div className="bg-primary text-primary-foreground rounded-full h-8 w-8 text-sm font-bold flex items-center justify-center absolute left-[-1rem] transform ring-4 ring-background">
                                  {event.type === 'work' ? <Briefcase className="h-4 w-4" /> : <Award className="h-4 w-4" />}
                              </div>
