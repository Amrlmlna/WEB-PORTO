...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  const isWebApp = project.tags.some(tag => ["React", "Next.js", "Svelte", "A-Frame", "Three.js"].includes(tag));
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="max-w-4xl mx-auto">
            <Link href="/#projects" className='mb-8 inline-block'>
                <Button variant="link" className="p-0 text-muted-foreground hover:text-foreground">← Back to all projects</Button>
            </Link>
            <h1 className="font-headline text-4xl md:text-6xl font-bold">{project.title}</h1>
            ...
            <div className="mt-12 flex gap-4">
              ...
              {project.repoUrl && (
                <Link href={project.repoUrl} target="_blank" rel="noopener noreferrer" passHref>
